...
- `postit/__main__.py` — argparse, `QApplication`, run the dialog, write the note, report failures with a `QMessageBox` (a bare stderr traceback is invisible when launched from a desktop icon).
